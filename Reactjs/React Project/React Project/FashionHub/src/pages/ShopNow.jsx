    ...
    return (
        <div>
            ...
            <div className='w-4/6 mx-20'>
                <div className=' grid  lg:grid-cols-4 grid-cols-1 slg:grid-cols-2 mlg:grid-cols-3  '>
                    {
                        ShopNow.map((item) => {
                            return (
                                <div key={item.id}>
                ...
                <div>
                    ...
                    <p className='text-gray-800'>Accessories (3)</p>
                    <p className='text-gray-800'>Bags (3)</p>
                    <p className='text-gray-800'>Best Selling (15)</p>
                    <p className='text-gray-800'>Clothes (6)</p>
                    <p className='text-gray-800'>Shoes (3)</p>
                    <div>
