...
function CardView() {
    ...
    return (
        <div>
            ...
            <div className='mt-10 grid lg:grid-cols-5 llmd:grid-cols-3 lmd:grid-cols-2 mmlg:grid-cols-3  slg:grid-cols-4 justify-center '>
                {data.map((products) => (
                    <div key={products.id}>
                        <div className='box group w-32 vsm:w-40 lmd:w-52 relative mx-auto md:mx-7 my-4'>
                            <div className="relative">
                                <img src={products.img1} className="md:max-w-72 duration-100 ease-in-out hovertransition-all  hover:scale-100" alt="Imagem de perfil" />
                                <img src={products.img2} className="md:max-w-72 absolute top-0 left-0 z-0 opacity-0 hover:ease-linear hover:duration-700 hover:transition-all hover:scale-100 hover:opacity-100" alt="Nova imagem" />
                            ...
                            <div className='mt-3'>
                                <h1 className='md:text-2xl font-medium text-gray-800  '>{products.name}</h1>
                                <h3 className='vsm:text-md text-gray-800 mt-2'>{products.Showprice}</h3>
                            </div>
                        </div>
                    </div>
                ))};
